...
public abstract class Pack {
	...
	public static void littleEndianToInt(byte[] bs, int bOff, int[] ns, int nOff,
			int count) {
	...
	public static void littleEndianToLong(byte[] bs, int bsOff, long[] ns, int nsOff,
			int nsLen) {
	...
	public static void longToLittleEndian(long[] ns, int nsOff, int nsLen, byte[] bs,
			int bsOff) {
		for (int i = 0; i < nsLen; ++i) {
