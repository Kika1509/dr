...
public final class Arrays {
	...
	/**
	 * A constant time equals comparison - does not terminate early if test will fail. For
	...
	/**
	 * Make a copy of a range of bytes from the passed in data array. The range can extend
	 * beyond the end of the input array, in which case the return array will be padded
	 * with zeroes.
	 *
	...
	public static class Iterator<T> implements java.util.Iterator<T> {
		 ...
		 * Base constructor.
		 * <p>
		 * Note: the array is not cloned, changes to it will affect the values returned by
		 * next().
		 * </p>
		 *
