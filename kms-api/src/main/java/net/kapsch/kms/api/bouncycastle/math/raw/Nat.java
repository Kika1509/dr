package net.kapsch.kms.api.bouncycastle.math.raw;

import java.math.BigInteger;

import net.kapsch.kms.api.bouncycastle.util.Pack;
...
public abstract class Nat {
	...
	public static int addBothTo(int len, int[] x, int xOff, int[] y, int yOff, int[] z,
			int zOff) {
		long c = 0;
		for (int i = 0; i < len; ++i) {
	...
	public static void mul(int len, int[] x, int xOff, int[] y, int yOff, int[] zz,
			int zzOff) {
	...
	public static int mulAddTo(int len, int[] x, int xOff, int[] y, int yOff, int[] zz,
			int zzOff) {
		long zc = 0;
		for (int i = 0; i < len; ++i) {
	...
	public static int mul31BothAdd(int len, int a, int[] x, int b, int[] y, int[] z,
			int zOff) {
		long c = 0;
		long aVal = a & M;
		long bVal = b & M;
	...
	public static long shiftUpBit64(int len, long[] x, int xOff, long c, long[] z,
			int zOff) {
		for (int i = 0; i < len; ++i) {
			long next = x[xOff + i];
	...
	public static int shiftUpBits(int len, int[] x, int xOff, int bits, int c, int[] z,
			int zOff) {
		// assert bits > 0 && bits < 32;
		for (int i = 0; i < len; ++i) {
			int next = x[xOff + i];
	...
	public static long shiftUpBits64(int len, long[] x, int xOff, int bits, long c,
			long[] z, int zOff) {
		// assert bits > 0 && bits < 64;
		for (int i = 0; i < len; ++i) {
			long next = x[xOff + i];
	...
	public static int sub(int len, int[] x, int xOff, int[] y, int yOff, int[] z,
			int zOff) {
		long c = 0;
		for (int i = 0; i < len; ++i) {
	...
	public static int subBothFrom(int len, int[] x, int xOff, int[] y, int yOff, int[] z,
			int zOff) {
		long c = 0;
		for (int i = 0; i < len; ++i) {
