...
import net.kapsch.kms.api.bouncycastle.crypto.ExtendedDigest;
import net.kapsch.kms.api.bouncycastle.util.Memoable;
...
public abstract class GeneralDigest implements ExtendedDigest, Memoable {
	...
	/**
	 * Copy constructor. We are using copy constructors in place of the Object.clone()
	 * interface as this interface is not supported by J2ME.
	 */
