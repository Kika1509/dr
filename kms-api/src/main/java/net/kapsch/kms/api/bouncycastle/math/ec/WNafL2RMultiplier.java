...
public class WNafL2RMultiplier extends AbstractECMultiplier {
	/**
	 * Multiplies <code>this</code> by an integer <code>k</code> using the Window NAF
	 * method.
	 * @param k The integer by which <code>this</code> is multiplied.
	 * @return A new <code>ECPoint</code> which equals <code>this</code> multiplied by
	 * <code>k</code>.
	 */
	protected ECPoint multiplyPositive(ECPoint p, BigInteger k) {
		...
		if (i > 1) {
			...
			if ((n << 2) < (1 << width)) {
				...
				// TODO Get addition/doubling cost ratio from curve and compare to 'scale'
				// to see if worth substituting?
