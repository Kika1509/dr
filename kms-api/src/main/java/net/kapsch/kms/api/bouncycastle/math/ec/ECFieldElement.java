...
import net.kapsch.kms.api.bouncycastle.math.raw.Mod;
...
public abstract class ECFieldElement implements ECConstants {
	...
	public ECFieldElement multiplyMinusProduct(ECFieldElement b, ECFieldElement x,
			ECFieldElement y) {
		return multiply(b).subtract(x.multiply(y));
	}

	public ECFieldElement multiplyPlusProduct(ECFieldElement b, ECFieldElement x,
			ECFieldElement y) {
	...
	public static class Fp extends ECFieldElement {
		...
		public ECFieldElement sqrt() {
			...
			BigInteger k = legendreExponent.add(ONE);
			...
			do {
				...
				while (P.compareTo(q) >= 0 || !modReduce(P.multiply(P).subtract(fourX))
	 ...
	 * <code>F<sub>2<sup>m</sup></sub></code> in polynomial basis (PB) representation.
	 * Both trinomial (TPB) and pentanomial (PPB) polynomial basis representations are
	...
	public static class F2m extends ECFieldElement {
		 ...
		 * @throws IllegalArgumentException if <code>a</code> and <code>b</code> are not
		 * elements of the same field <code>F<sub>2<sup>m</sup></sub></code> (having the
		 * same representation).
		 */
		...
		/**
		 * @return the representation of the field <code>F<sub>2<sup>m</sup></sub></code>,
		 * either of TPB (trinomial basis representation) or PPB (pentanomial basis
		 * representation).
		 */
		...
		public boolean equals(Object anObject) {
			...
			return ((this.m == b.m) && (this.representation == b.representation)
					&& Arrays.areEqual(this.ks, b.ks) && (this.x.equals(b.x)));
		}
