...
public class WNafPreCompInfo implements PreCompInfo {
	...
	/**
	 * Array holding the negations of the precomputed <code>ECPoint</code>s used for a
	 * Window NAF multiplication.
	 */
	protected ECPoint[] preCompNeg = null;

	/**
	 * Holds an <code>ECPoint</code> representing twice(this). Used for the Window NAF
	 * multiplication to create or extend the precomputed values.
	 */
